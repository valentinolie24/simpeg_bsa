            ...
            <div class="intro-y box">
                <div
                    ...
                    <div class="form-check form-switch w-full sm:w-auto sm:ml-auto mt-3 sm:mt-0">
                        ...
                        <input id="show-example-1" data-target="#blank-modal" class="show-code form-check-input mr-0 ml-3"
                            type="checkbox">
                    </div>
                </div>
                                    ...
                                    {{ str_replace(
                                        ...
                                        str_replace(
                                            ...
                                            '
                                                                            ...
                                                                            <!-- END: Modal Toggle --><!-- BEGIN: Modal Content --><div id="basic-modal-preview" class="modal" tabindex="-1" aria-hidden="true">
                                                                                <div class="modal-dialog">
                                                                                    <div class="modal-content">
                                                                                        <div class="modal-body p-10 text-center">
                                                                                            This is totally awesome blank modal!
            ...
            <div class="intro-y box mt-5">
                <div
                    ...
                    <div class="form-check form-switch w-full sm:w-auto sm:ml-auto mt-3 sm:mt-0">
                        ...
                        <input data-target="#modal-size" class="show-code form-check-input mr-0 ml-3" type="checkbox"
                            id="show-example-2">
                    </div>
                </div>
                <div id="modal-size" class="p-5">
                    <div class="preview">
                        <div class="text-center">
                            ...
                            <a href="javascript:;" data-tw-toggle="modal" data-tw-target="#small-modal-size-preview"
                                class="btn btn-primary mr-1 mb-2">Show Small Modal</a>
                            <!-- END: Small Modal Toggle -->
                            <!-- BEGIN: Medium Modal Toggle -->
                            <a href="javascript:;" data-tw-toggle="modal" data-tw-target="#medium-modal-size-preview"
                                class="btn btn-primary mr-1 mb-2">Show Medium Modal</a>
                            <!-- END: Medium Modal Toggle -->
                            <!-- BEGIN: Large Modal Toggle -->
                            <a href="javascript:;" data-tw-toggle="modal" data-tw-target="#large-modal-size-preview"
                                class="btn btn-primary mr-1 mb-2">Show Large Modal</a>
                            <!-- END: Large Modal Toggle -->
                            <!-- BEGIN: Super Large Modal Toggle -->
                            <a href="javascript:;" data-tw-toggle="modal" data-tw-target="#superlarge-modal-size-preview"
                                class="btn btn-primary mr-1 mb-2">Show Superlarge Modal</a>
                                ...
                                <code class="html">
                                    {{ str_replace(
                                        ...
                                        str_replace(
                                            ...
                                            '
                                                                            <div class="text-center">
                                                                                <!-- BEGIN: Small Modal Toggle --><a href="javascript:;" data-tw-toggle="modal" data-tw-target="#small-modal-size-preview" class="btn btn-primary mr-1 mb-2">Show Small Modal</a>
                                                                                <!-- END: Small Modal Toggle --><!-- BEGIN: Medium Modal Toggle --><a href="javascript:;" data-tw-toggle="modal" data-tw-target="#medium-modal-size-preview" class="btn btn-primary mr-1 mb-2">Show Medium Modal</a>
                                                                                <!-- END: Medium Modal Toggle --><!-- BEGIN: Large Modal Toggle --><a href="javascript:;" data-tw-toggle="modal" data-tw-target="#large-modal-size-preview" class="btn btn-primary mr-1 mb-2">Show Large Modal</a>
                                                                                <!-- END: Large Modal Toggle --><!-- BEGIN: Super Large Modal Toggle --><a href="javascript:;" data-tw-toggle="modal" data-tw-target="#superlarge-modal-size-preview" class="btn btn-primary mr-1 mb-2">Show Superlarge Modal</a>
                                                                                <!-- END: Super Large Modal Toggle --></div>
                                                                            <!-- BEGIN: Small Modal Content --><div id="small-modal-size-preview" class="modal" tabindex="-1" aria-hidden="true">
                                                                                <div class="modal-dialog modal-sm">
                                                                                    <div class="modal-content">
                                                                                        <div class="modal-body p-10 text-center">
                                                                                            This is totally awesome small modal!
                                                                            ...
                                                                            <!-- END: Small Modal Content --><!-- BEGIN: Medium Modal Content --><div id="medium-modal-size-preview" class="modal" tabindex="-1" aria-hidden="true">
                                                                                <div class="modal-dialog">
                                                                                    <div class="modal-content">
                                                                                        <div class="modal-body p-10 text-center">
                                                                                            This is totally awesome medium modal!
                                                                            ...
                                                                            <!-- END: Medium Modal Content --><!-- BEGIN: Large Modal Content --><div id="large-modal-size-preview" class="modal" tabindex="-1" aria-hidden="true">
                                                                                <div class="modal-dialog modal-lg">
                                                                                    <div class="modal-content">
                                                                                        <div class="modal-body p-10 text-center">
                                                                                            This is totally awesome large modal!
                                                                            ...
                                                                            <!-- END: Large Modal Content --><!-- BEGIN: Super Large Modal Content --><div id="superlarge-modal-size-preview" class="modal" tabindex="-1" aria-hidden="true">
                                                                                <div class="modal-dialog modal-xl">
                                                                                    <div class="modal-content">
                                                                                        <div class="modal-body p-10 text-center">
                                                                                            This is totally awesome superlarge modal!
            ...
            <div class="intro-y box mt-5">
                <div
                    ...
                    <div class="form-check form-switch w-full sm:w-auto sm:ml-auto mt-3 sm:mt-0">
                        ...
                        <input id="show-example-4" data-target="#warning-modal"
                ...
                <div id="warning-modal" class="p-5">
                    <div class="preview">
                        <!-- BEGIN: Modal Toggle -->
                        <div class="text-center">
                            <a href="javascript:;" data-tw-toggle="modal" data-tw-target="#warning-modal-preview"
                                class="btn btn-primary">Show Modal</a>
                        </div>
                        <!-- END: Modal Toggle -->
                        <!-- BEGIN: Modal Content -->
                                    ...
                                    <div class="modal-body p-0">
                                        ...
                                        <div class="px-5 pb-8 text-center">
                                            <button type="button" data-tw-dismiss="modal"
                                                class="btn w-24 btn-primary">Ok</button>
                                        </div>
                                    ...
                                    {{ str_replace(
                                        ...
                                        str_replace(
                                            ...
                                            '
                                                                            ...
                                                                            <!-- END: Modal Toggle --><!-- BEGIN: Modal Content --><div id="warning-modal-preview" class="modal" tabindex="-1" aria-hidden="true">
                                                                                <div class="modal-dialog">
                                                                                    <div class="modal-content">
                                                                                        <div class="modal-body p-0">
                                                                                            <div class="p-5 text-center">
            ...
            <div class="intro-y box mt-5">
                <div
                    ...
                    <div class="form-check form-switch w-full sm:w-auto sm:ml-auto mt-3 sm:mt-0">
                        ...
                        <input id="show-example-5" data-target="#button-modal"
                            class="show-code form-check-input mr-0 ml-3" type="checkbox">
                    </div>
                </div>
                                    ...
                                    {{ str_replace(
                                        ...
                                        str_replace(
                                            ...
                                            '
                                                                            ...
                                                                            <!-- END: Modal Toggle --><!-- BEGIN: Modal Content --><div id="button-modal-preview" class="modal" tabindex="-1" aria-hidden="true">
                                                                                <div class="modal-dialog">
                                                                                    <div class="modal-content">
                                                                                        <a data-tw-dismiss="modal" href="javascript:;">
                                                                                            <i data-lucide="x" class="w-8 h-8 text-slate-400"></i>
            ...
            <div class="intro-y box mt-5">
                <div
                    ...
                    <div class="form-check form-switch w-full sm:w-auto sm:ml-auto mt-3 sm:mt-0">
                        ...
                        <input id="show-example-11" data-target="#static-backdrop-modal"
                            class="show-code form-check-input mr-0 ml-3" type="checkbox">
                    </div>
                </div>
                <div id="static-backdrop-modal" class="p-5">
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-body px-5 py-10">
                                        <div class="text-center">
                                            <div class="mb-5">I will not close if you click outside me. Don't even try to
                                                press escape key.</div>
                                            <button type="button" data-tw-dismiss="modal"
                                                class="btn btn-primary w-24">Ok</button>
                                        </div>
                                    </div>
                    ...
                    <div class="source-code hidden">
                        <button data-target="#copy-static-backdrop-modal"
                                    ...
                                    {{ str_replace(
                                        ...
                                        str_replace(
                                            ...
                                            '
                                                                            ...
                                                                            <!-- END: Modal Toggle --><!-- BEGIN: Modal Content --><div id="static-backdrop-modal-preview" class="modal" data-tw-backdrop="static" tabindex="-1" aria-hidden="true">
                                                                                <div class="modal-dialog">
                                                                                    <div class="modal-content">
                                                                                        <div class="modal-body px-5 py-10">
                                                                                            <div class="text-center">
            ...
            <div class="intro-y box mt-5">
                <div
                    ...
                    <div class="form-check form-switch w-full sm:w-auto sm:ml-auto mt-3 sm:mt-0">
                        ...
                        <input id="show-example-6" data-target="#overlapping-modal"
                            class="show-code form-check-input mr-0 ml-3" type="checkbox">
                    </div>
                </div>
                <div id="overlapping-modal" class="p-5">
                    <div class="preview">
                        <!-- BEGIN: Modal Toggle -->
                        <div class="text-center">
                            <a href="javascript:;" data-tw-toggle="modal" data-tw-target="#overlapping-modal-preview"
                                class="btn btn-primary">Show Modal</a>
                        </div>
                        <!-- END: Modal Toggle -->
                        <!-- BEGIN: Modal Content -->
                    ...
                    <div class="source-code hidden">
                        <button data-target="#copy-overlapping-modal"
                            class="copy-code btn py-1 px-2 btn-outline-secondary">
                            <i data-lucide="file" class="w-4 h-4 mr-2"></i> Copy example code
                        </button>
                        <div class="overflow-y-auto mt-3 rounded-md">
                                    ...
                                    {{ str_replace(
                                        ...
                                        str_replace(
                                            ...
                                            '
                                                                            ...
                                                                            <!-- END: Modal Toggle --><!-- BEGIN: Modal Content --><div id="overlapping-modal-preview" class="modal" tabindex="-1" aria-hidden="true">
                                                                                <div class="modal-dialog">
                                                                                    <div class="modal-content">
                                                                                        <div class="modal-body px-5 py-10">
                                                                                            <div class="text-center">
                                                                                                <div class="mb-5">Click button bellow to show overlapping modal!</div>
                                                                                                <!-- BEGIN: Overlapping Modal Toggle --><a href="javascript:;" data-tw-toggle="modal" data-tw-target="#next-overlapping-modal-preview" class="btn btn-primary">Show Overlapping Modal</a>
                                                                                                <!-- END: Overlapping Modal Toggle --></div>
                                                                                            <!-- BEGIN: Overlapping Modal Content --><div id="next-overlapping-modal-preview" class="modal" tabindex="-1" aria-hidden="true">
                                                                                                <div class="modal-dialog">
                                                                                                    <div class="modal-content">
                                                                                                        <div class="modal-body text-center">
                                                                                                            This is totally awesome overlapping modal!
                                                                                            ...
                                                                                            <!-- END: Overlapping Modal Content --></div>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            <!-- END: Modal Content -->',
            ...
            <div class="intro-y box mt-5">
                <div
                    ...
                    <div class="form-check form-switch w-full sm:w-auto sm:ml-auto mt-3 sm:mt-0">
                        ...
                        <input id="show-example-7" data-target="#header-footer-modal"
                            class="show-code form-check-input mr-0 ml-3" type="checkbox">
                    </div>
                </div>
                                    ...
                                    {{ str_replace(
                                        ...
                                        str_replace(
                                            ...
                                            '
                                                                            ...
                                                                            <!-- END: Modal Toggle --><!-- BEGIN: Modal Content --><div id="header-footer-modal-preview" class="modal" tabindex="-1" aria-hidden="true">
                                                                                <div class="modal-dialog">
                                                                                    <div class="modal-content">
                                                                                        <!-- BEGIN: Modal Header --><div class="modal-header">
                                                                                            <h2 class="font-medium text-base mr-auto">Broadcast Message</h2>
                                                                                            <button class="btn btn-outline-secondary hidden sm:flex">
                                                                                                <i data-lucide="file" class="w-4 h-4 mr-2"></i> Download Docs
                                                                                            </button>
                                                                                        ...
                                                                                        <!-- END: Modal Header --><!-- BEGIN: Modal Body --><div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
                                                                                            <div class="col-span-12 sm:col-span-6">
                                                                                                <label for="modal-form-1" class="form-label">From</label>
                                                                                        ...
                                                                                        <!-- END: Modal Body --><!-- BEGIN: Modal Footer --><div class="modal-footer">
            ...
            <div class="intro-y box mt-5">
                <div
                    ...
                    <div class="form-check form-switch w-full sm:w-auto sm:ml-auto mt-3 sm:mt-0">
                        ...
                        <input id="show-example-8" data-target="#delete-modal"
                            class="show-code form-check-input mr-0 ml-3" type="checkbox">
                    </div>
                </div>
                                    ...
                                    {{ str_replace(
                                        ...
                                        str_replace(
                                            ...
                                            '
                                                                            ...
                                                                            <!-- END: Modal Toggle --><!-- BEGIN: Modal Content --><div id="delete-modal-preview" class="modal" tabindex="-1" aria-hidden="true">
                                                                                <div class="modal-dialog">
                                                                                    <div class="modal-content">
                                                                                        <div class="modal-body p-0">
                                                                                            <div class="p-5 text-center">
            ...
            <div class="intro-y box mt-5">
                <div
                    ...
                    <div class="form-check form-switch w-full sm:w-auto sm:ml-auto mt-3 sm:mt-0">
                        ...
                        <input id="show-example-9" data-target="#success-modal"
                            class="show-code form-check-input mr-0 ml-3" type="checkbox">
                    </div>
                </div>
                <div id="success-modal" class="p-5">
                    <div class="preview">
                        <!-- BEGIN: Modal Toggle -->
                        <div class="text-center">
                            <a href="javascript:;" data-tw-toggle="modal" data-tw-target="#success-modal-preview"
                                class="btn btn-primary">Show Modal</a>
                        </div>
                        <!-- END: Modal Toggle -->
                        <!-- BEGIN: Modal Content -->
                                    ...
                                    {{ str_replace(
                                        ...
                                        str_replace(
                                            ...
                                            '
                                                                            ...
                                                                            <!-- END: Modal Toggle --><!-- BEGIN: Modal Content --><div id="success-modal-preview" class="modal" tabindex="-1" aria-hidden="true">
                                                                                <div class="modal-dialog">
                                                                                    <div class="modal-content">
                                                                                        <div class="modal-body p-0">
                                                                                            <div class="p-5 text-center">
            ...
            <div class="intro-y box mt-5">
                <div
                    ...
                    <div class="form-check form-switch w-full sm:w-auto sm:ml-auto mt-3 sm:mt-0">
                        ...
                        <input id="show-example-10" data-target="#tiny-slider-modal"
                            class="show-code form-check-input mr-0 ml-3" type="checkbox">
                    </div>
                </div>
                <div id="tiny-slider-modal" class="p-5">
                    <div class="preview">
                        <!-- BEGIN: Modal Toggle -->
                        <div class="text-center">
                            <a href="javascript:;" data-tw-toggle="modal" data-tw-target="#tiny-slider-modal-preview"
                                class="btn btn-primary">Show Modal</a>
                        </div>
                        <!-- END: Modal Toggle -->
                        <!-- BEGIN: Modal Content -->
                                        ...
                                        <div class="mx-6">
                                            <div class="center-mode">
                                                ...
                                                <div class="h-56 px-2">
                                                    <div class="h-full image-fit rounded-md overflow-hidden">
                                                        <img alt="Midone - HTML Admin Template"
                                                            src="{{ asset('dist/images/' . $fakers[0]['images'][1]) }}" />
                                                    </div>
                                                </div>
                                                <div class="h-56 px-2">
                                                    <div class="h-full image-fit rounded-md overflow-hidden">
                                                        <img alt="Midone - HTML Admin Template"
                                                            src="{{ asset('dist/images/' . $fakers[0]['images'][2]) }}" />
                                                    </div>
                                                </div>
                                                <div class="h-56 px-2">
                                                    <div class="h-full image-fit rounded-md overflow-hidden">
                                                        <img alt="Midone - HTML Admin Template"
                                                            src="{{ asset('dist/images/' . $fakers[0]['images'][3]) }}" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="source-code hidden">
                        <button data-target="#copy-tiny-slider-modal"
                            class="copy-code btn py-1 px-2 btn-outline-secondary">
                            <i data-lucide="file" class="w-4 h-4 mr-2"></i> Copy example code
                        </button>
                        <div class="overflow-y-auto mt-3 rounded-md">
                                    ...
                                    {{ str_replace(
                                        ...
                                        str_replace(
                                            ...
                                            '
                                                                            ...
                                                                            <!-- END: Modal Toggle --><!-- BEGIN: Modal Content --><div id="tiny-slider-modal-preview" class="modal" tabindex="-1" aria-hidden="true">
                                                                                <div class="modal-dialog">
                                                                                    <div class="modal-content">
                                                                                        <div class="modal-body">
                                                                                            <div class="mx-6">
                                                ...
                                                '" />
                                                                                                    ...
                                                                                                    <div class="h-56 px-2">
                                                                                                        <div class="h-full image-fit rounded-md overflow-hidden">
                                                                                                            <img alt="Midone - HTML Admin Template" src="' .
                                                asset('dist/images/' . $fakers[0]['images'][2]) .
                                                '" />
                                                                                                        </div>
                                                                                                    </div>
                                                                                                    <div class="h-56 px-2">
                                                                                                        <div class="h-full image-fit rounded-md overflow-hidden">
                                                                                                            <img alt="Midone - HTML Admin Template" src="' .
                                                asset('dist/images/' . $fakers[0]['images'][3]) .
                                                '" />
                                                                                                        </div>
                                                                                                    </div>
                                                                                                </div>
            ...
            <div class="intro-y box mt-5">
                <div
                    ...
                    <div class="form-check form-switch w-full sm:w-auto sm:ml-auto mt-3 sm:mt-0">
                        ...
                        <input id="show-example-3" data-target="#programmatically-show-hide-modal"
                            class="show-code form-check-input mr-0 ml-3" type="checkbox">
                    </div>
                </div>
                <div id="programmatically-show-hide-modal" class="p-5">
                    <div class="preview">
                        ...
                        <div class="text-center">
                            <a id="programmatically-show-modal" href="javascript:;"
                                class="btn btn-primary mr-1 mb-2">Show Modal</a>
                        </div>
                    ...
                    <div class="source-code hidden">
                        <button data-target="#copy-programmatically-show-hide-modal-js"
                            class="copy-code btn py-1 px-2 btn-outline-secondary">
                            <i data-lucide="file" class="w-4 h-4 mr-2"></i> Copy example code
                        </button>
                        <div class="overflow-y-auto mt-3 rounded-md">
                                ...
                                <code class="html">
                                    {{ str_replace(
                                        ...
                                        str_replace(
                                            ...
                                            'HTMLOpenTag',
                                            '
                                                                            <!-- BEGIN: Show Modal Toggle --><div class="text-center">
                                                                                <a id="programmatically-show-modal" href="javascript:;" class="btn btn-primary mr-1 mb-2">Show Modal</a>
                                                                            </div>
                                                                            <!-- END: Show Modal Toggle --><!-- BEGIN: Modal Content --><div id="programmatically-modal" class="modal" tabindex="-1" aria-hidden="true">
                                                                                <div class="modal-dialog">
                                                                                    <div class="modal-content">
                                                                                        <div class="modal-body p-10 text-center">
                                                                                            <!-- BEGIN: Hide Modal Toggle --><a id="programmatically-hide-modal" href="javascript:;" class="btn btn-primary mr-1">Hide Modal</a>
                                                                                            <!-- END: Hide Modal Toggle --><!-- BEGIN: Toggle Modal Toggle --><a id="programmatically-toggle-modal" href="javascript:;" class="btn btn-primary mr-1">Toggle Modal</a>
                                                                                            <!-- END: Toggle Modal Toggle --></div>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            <!-- END: Modal Content -->',
                        ...
                        <button data-target="#copy-programmatically-show-hide-modal-html"
        ...
        <div class="intro-y col-span-12 lg:col-span-6">
            ...
            <div class="intro-y box">
                ...
                <div class="p-5">
                    ...
                    <div class="mt-2">Static method which allows you to get the modal instance associated with a DOM
                        element, or create a new one in case it wasn’t initialized.</div>
                    <div class="overflow-y-auto mt-3 rounded-md">
                    ...
                    <div class="mt-2">Manually hides a modal. Returns to the caller before the modal has actually been
                        hidden (i.e. before the <span class="text-red-500">hidden.tw.modal</span> event occurs).</div>
                    <div class="overflow-y-auto mt-3 rounded-md">
                        <pre class="source-preview">
                            <code class="javascript">
                                myModal.hide();
                    ...
                    <div class="mt-2">Manually opens a modal. Returns to the caller before the modal has actually been
                        shown (i.e. before the <span class="text-red-500">shown.tw.modal</span> event occurs).</div>
                    <div class="overflow-y-auto mt-3 rounded-md">
                        <pre class="source-preview">
                            <code class="javascript">
                                myModal.show();
                    ...
                    <div class="mt-2">Manually toggles a modal. Returns to the caller before the modal has actually been
                        shown or hidden (i.e. before the <span class="text-red-500">shown.tw.modal</span> or <span
                            class="text-red-500">hidden.tw.modal</span> event occurs).</div>
                    <div class="overflow-y-auto mt-3 rounded-md">
                        <pre class="source-preview">
                            <code class="javascript">
                                myModal.toggle();
            ...
            <div class="intro-y box mt-5">
                ...
                <div class="p-5">
                    Midone’s modal class exposes a few events for hooking into modal functionality. All modal events are
                    fired at the modal itself (i.e. at the <span class="text-red-500">&lt;div class="modal"&gt;</span>).
                    <table class="table">
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="align-top">This event fires immediately when the <span
                                        class="text-red-500">show</span> instance method is called.</td>
                            </tr>
                            <tr>
                                <td class="align-top text-red-500">shown.tw.modal</td>
                                <td class="align-top">This event is fired when the modal has been made visible to the user
                                    (will wait for CSS transitions to complete)</td>
                            </tr>
                            <tr>
                                <td class="align-top text-red-500">hide.tw.modal</td>
                                <td class="align-top">This event is fired immediately when the <span
                                        class="text-red-500">hide</span> instance method has been called.</td>
                            </tr>
                            <tr>
                                <td class="align-top text-red-500">hidden.tw.modal</td>
                                <td class="align-top">This event is fired when the modal has finished being hidden from the
